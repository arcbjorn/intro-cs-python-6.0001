...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        def do_shift(char, shift):
            """
            Returns a shifted character (ASCII char with shifted value).
        ...
        def calc_shift(char):
            """
            Calculates the amount to shift a character.

            :param char: char to shift
            :type char: str
            :returns: amount of shift
            :rtype: int
            """
            shifted_char = do_shift(char, shift)
            if shifted_char.isalpha() and shifted_char.isupper() == char.isupper():
                return shift
            else:
                return shift - 26
    ...
    def apply_shift(self, shift):
        ...
        #     shifted_message.append(shift_dict[let])
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        def get_valid_count(shift):
            ...
            valid_words = [
                word for word in words if is_word(self.valid_words, word)]
